...
<body>
<form id="form1" method="post" action="createOrder_do.php">
<input name="txnCod"   type="hidden" id="txnCod"  value="MerchantmerchantPay" />
<label for="prodCode"    >商户购买产品编码    </label><input name="prodCode"     type="text" id="prodCode"     maxlength="33"  value="CP00000007" /><br />
