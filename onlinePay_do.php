...
if(isset($_POST['submit'])) {
    ...
    $nof->setParameter("prdOrdType",   $_POST['prdOrdType']);
    ...
    if($signType=='MD5'){ //MD5加密
        //设置参与MD5加签的字段
        $paraArr = array("merchantId","prodCode","orderId","orderAmount","orderDate","prdOrdType","retUrl","returnUrl","prdName","prdDesc","signType");
        //对指定字段进行加签
